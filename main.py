...
player_items = [{"item": potion, "quantity" : 15}, {"item": highpotion, "quantity": 5},
                {"item": superpotion, "quantity": 5}, {"item": elexir, "quantity": 5}, {"item": hielixir, "quantity": 2}, {"item": granade, "quantity": 5}]
...
while running:
    ...
    if index == 0:
        ...
        if spell.type == "white":
            ...
            print(bcolors.OKBLUE + "/n" + spell.name + "heals for", str(magic_dmg), "HP." + bcolors.ENDC)
        ...
        if item.type == "potion":
            ...
            print(bcolors.OKGREEN + "\n" + item.name + " heaks for", str(item.prop), "HP" + bcolors.ENDC)
            ...
            print(bcolors.FAIL + "\n" + item.name + " deals", str(item.prop), "points of damage" + bcolors.ENDS)        
